  ...
  return (
    ...
    <nav class="navbar">
        <a class="navbar-brand" href="./index.html">
            ...
            <img src="./img/gonzaga_logo.png" width="600" height="100" alt=""/>
          </a>
    </nav>

    <div class="list-group center">
        <button type="button" class="btn btn-primary" onclick="window.location.href='./status.html'">
            ...
            <div class = "expanded-text">
                <h1 class="short-name">View Status</h1>
                <span class="longer-name">View Registration Status, update student term data, and
                    complete pre-registration requirments</span>
            </div>
        </button>
        <button type="button" class="btn btn-primary" class="button" onclick="window.location.href='./registration.html'">
            <div class="float-left">
            ...
            <div class="expanded-text">
                <h1 class="short-name">Register</h1>
                <span class="longer-name">View Registration Status, update student term data, and
                    complete pre-registration requirments</span>
            </div>
        ...
        <button class="btn btn-primary">
            ...
            <div class = "expanded-text">
                <h1 class="short-name">Browse All Classes</h1>
